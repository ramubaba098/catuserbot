...
@borg.on(admin_cmd(pattern="music320(?: |$)(.*)"))
async def _(event):
    reply_to_id = event.message.id
    if event.reply_to_msg_id:
        reply_to_id = event.reply_to_msg_id
...
@borg.on(admin_cmd(pattern="vmusic(?: |$)(.*)"))
async def _(event):
    reply_to_id = event.message.id
    if event.reply_to_msg_id:
        reply_to_id = event.reply_to_msg_id
...
@borg.on(sudo_cmd(pattern="vmusic(?: |$)(.*)", allow_sudo = True))
async def _(event):
    reply_to_id = event.message.id
    if event.reply_to_msg_id:
        reply_to_id = event.reply_to_msg_id
...
CMD_HELP.update({"musics":
    "`.music` query or `.music` reply to song name :\
    \nUSAGE:finds the song you entered in query and sends it"
    "`.vmusic` query or `.vmusic` reply to song name :\
